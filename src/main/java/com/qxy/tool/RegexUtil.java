...
//    String str = "/bbb/ccc/333.html";
//    String replace = str.replace(".html", "").replace("/", "_");
//    System.out.println(replace);
//    String str2 = replaceBetween(str, "\\d+(\\.html)", "");
//    System.out.println(str2);
//    System.out.println(str2.replace("/","_"));

        String str = "/aaa/sss/bbb/ccc/333.html";
        //    String str2 = replace(str, "/\\d+\\.html", "");
        //    System.out.println(str2);
        //    List<String> strings = searchListBetween(str2, "/(\\w+)");
        //    strings.forEach(s -> System.out.println(s));
        //
//    List<String> strings1 = searchListBetween(str, "/(\\w+)");
//    strings1.forEach(s -> System.out.println(s));

        String search = search(str, "(/\\w+)+");
...
//    System.out.println(findCount("/sss/sss", "s"));
    ...
    public static String URL_REGEX = "((http|ftp|https)://)(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\\&%_\\./-~-]*)?";
    ...
    public static boolean isEnglishWord(String string) {
        return match(string.toLowerCase(), "[a-z|A-Z]+");
    }
     ...
     * @return
     */
    public static boolean isPureEnglishWord(String str) {
     ...
     * 将正则表达式匹配的部分替换成空白
     */
    public static String remove(String orgStr, String regex) {
    ...
    public static Integer parseInteger(String str) {
        if (str == null)
            return null;
        String search = search(str, "\\d+");
        if (search != null && search.equals(str))
